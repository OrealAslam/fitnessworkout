...
const BoardingScreen2 = ({ navigation }: { navigation: any }) => {
  ...
  return (
    <ImageBackground style={styles.bg} source={require('../../assets/boarding/boardingtobg.png')}>
      <View style={styles.header}>
        <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate('BoardingScreen1')}>
      ...
      <View style={styles.mainContent}>
        <View>
          <Text style={styles.highlightText}>How Much Do</Text>
          <Text style={styles.highlightText}>You Weight</Text>
        </View>
