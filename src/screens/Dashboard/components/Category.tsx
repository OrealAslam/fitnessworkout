...
const Category = (props:any) => {
    return (
        <View style={styles.cardContainer}>
            <TouchableOpacity onPress={()=>props.navigation.navigate('CategoryScreen', {type: 'fullbody'})}>
                <Image style={styles.card} source={require('../../../assets/images/fullbody.png')} />
            </TouchableOpacity>

            <TouchableOpacity onPress={()=>props.navigation.navigate('CategoryScreen', {type: 'buttleg'})}>
            ...
            <TouchableOpacity onPress={()=>props.navigation.navigate('CategoryScreen', {type: 'arms'})} >
